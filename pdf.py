...
def create_invoice(res_id):
    ...
    c.setFont('CalibriBold', 11)
    c.drawString(58, 690, "Rechnungsnummer")
    c.setFont('Calibri', 11)
    c.drawString(178, 690, "1")
    c.setFont('CalibriBold', 11)
    c.drawString(358, 690, "Datum")
    c.setFont('Calibri', 11)
    c.drawString(458, 690, Date.get_current())
    c.setFont('CalibriBold', 11)
    c.drawString(58, 675, "Anreise")
    c.setFont('Calibri', 11)
    c.drawString(178, 675, r.dateFrom)
    c.setFont('CalibriBold', 11)
    c.drawString(358, 675, "Abreise")
    c.setFont('Calibri', 11)
    c.drawString(458, 675, r.dateTo)
    c.setFont('CalibriBold', 11)
    c.drawString(58, 660, "Gastname")
    c.setFont('Calibri', 11)
    c.drawString(178, 660, r.name)
    c.setFont('CalibriBold', 11)
    c.drawString(358, 660, "Personenzahl")
    c.setFont('Calibri', 11)
    c.drawString(458, 660, str(r.count))
    ...
    c.line(188, 620, 188, 545)
    c.line(478, 620, 478, 545)
