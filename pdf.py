...
def create_invoice(res_id):
    ...
    c.drawString(58, 815, "Rechnung")

    c.setFont('Calibri', 11)

    c.setFont('CalibriBold', 11)
    c.drawString(58, 790, "Rechnungsnummer")
    c.setFont('Calibri', 11)
    c.drawString(178, 790, "1")
    c.setFont('CalibriBold', 11)
    c.drawString(358, 790, "Datum")
    c.setFont('Calibri', 11)
    c.drawString(458, 790, Date.get_current())
    c.setFont('CalibriBold', 11)
    c.drawString(58, 775, "Anreise")
    c.setFont('Calibri', 11)
    c.drawString(178, 775, r.dateFrom)
    c.setFont('CalibriBold', 11)
    c.drawString(358, 775, "Abreise")
    c.setFont('Calibri', 11)
    c.drawString(458, 775, r.dateTo)
    c.setFont('CalibriBold', 11)
    c.drawString(58, 760, "Gastname")
    c.setFont('Calibri', 11)
    c.drawString(178, 760, r.name)
    c.setFont('CalibriBold', 11)
    c.drawString(358, 760, "Personenzahl")
    c.setFont('Calibri', 11)
    c.drawString(458, 760, str(r.count))
